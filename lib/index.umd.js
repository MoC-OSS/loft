(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('pino'), require('chalk'), require('bullmq'), require('zod'), require('luxon'), require('uuid'), require('@google-cloud/aiplatform'), require('@aws-sdk/client-s3'), require('@google-cloud/storage')) :
    typeof define === 'function' && define.amd ? define(['exports', 'pino', 'chalk', 'bullmq', 'zod', 'luxon', 'uuid', '@google-cloud/aiplatform', '@aws-sdk/client-s3', '@google-cloud/storage'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["loft-palm"] = {}, global.pino, global.chalk, global.bullmq, global.zod, global.luxon, global.uuid, global.aiplatform, global.clientS3, global.storage));
})(this, (function (exports, pino, chalk, bullmq, zod, luxon, uuid, aiplatform, clientS3, storage) { 'use strict';
    ...
    function getTimestamp() {
        return luxon.DateTime.local().toUTC().toSeconds();
    }
    ...
    const ChatCompletionInputSchema = zod.z.object({
        systemMessageName: zod.z
            .string()
    ...
    class Palm {
        ...
        constructor(project, apiEndpoint = 'us-central1-aiplatform.googleapis.com', location = 'us-central1', publisher = 'google') {
            ...
            this.predictionServiceClient = new aiplatform.PredictionServiceClient(clientOptions);
        }
        getEndpoint(model) {
        ...
        async callPredict(instance, parameters, model = 'chat-bison@001') {
            ...
            const request = {
                endpoint,
                instances: [aiplatform.helpers.toValue(instance)],
            ...
            try {
                ...
                const result = {
                    predictions: resData.map((element) => {
                        return aiplatform.helpers.fromValue(element);
                    }),
                    metadata: aiplatform.helpers.fromValue(response.metadata),
                };
                return result;
            }
            catch (error) {
    ...
    class ChatCompletion {
        ...
        constructor(cfg, sms, ps, hs, errorHandler) {
            ...
            this.completionQueue = new bullmq.Queue('chatCompletionQueue', {
                connection: {
            ...
            this.completionWorker = new bullmq.Worker('chatCompletionQueue', async (job) => this.chatCompletionBeginProcessor(job), {
                connection: {
                    host: this.cfg.redisHost,
                    port: this.cfg.redisPort,
                    db: this.cfg.bullMqDb,
            ...
            this.llmApiCallQueue = new bullmq.Queue('llmApiCallQueue', {
                connection: {
                    host: this.cfg.redisHost,
                    port: this.cfg.redisPort,
                    db: this.cfg.bullMqDb,
            ...
            this.llmApiCallWorker = new bullmq.Worker('llmApiCallQueue', async (job) => this.chatCompletionCallProcessor(job), {
                limiter: {
    ...
    const ModelPresetSchema = zod.z.object({
        temperature: zod.z.number(),
        maxOutputTokens: zod.z.number(),
        topP: zod.z.number(),
        topK: zod.z.number(),
    });
    const ExampleSchema = zod.z.object({
        input: zod.z.object({
    ...
    const SystemMessageSchema = zod.z.object({
        name: zod.z
            .string()
            .refine((name) => redisKeyRegex.test(name), 'Invalid systemMessages.name value. Allowed only alphanumeric characters (a-z, A-Z, 0-9) and the specified symbols (: . - _)'),
        systemMessage: zod.z.string(),
        examples: zod.z.array(ExampleSchema),
        model: zod.z.string(),
        modelPreset: ModelPresetSchema,
    });
    const createChatCompletionRequestSchema = zod.z
        .object({
        systemMessages: zod.z.array(SystemMessageSchema),
    })
        .strict();

    const PromptSchema = zod.z.object({
        prompts: zod.z.array(zod.z.object({
            name: zod.z.string(),
            prompt: zod.z.string(),
        })),
    });
    ...
    class S3Service {
        ...
        constructor(env, region, bucketName, appName) {
            ...
            this.client = new clientS3.S3Client({ region: this.region });
        ...
        async getFile(filename) {
            try {
                ...
                if (err instanceof clientS3.S3ServiceException &&
    ...
    exports.MiddlewareStatuses = MiddlewareStatuses;
