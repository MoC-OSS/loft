...
exports.createChatCompletionRequestSchema = zod_1.z.object({
    preheaders: zod_1.z.array(zod_1.z.object({
        name: zod_1.z.string(),
        preheader: zod_1.z.string(),
        modelPreset: zod_1.z.object({
            ...
            user: zod_1.z
                .string()
                .optional()
                .describe('A unique identifier representing your end-user, which can help OpenAI to monitor and detect abuse. [Learn more](/docs/guides/safety-best-practices/end-user-ids).'),
        }),
    })),
});
