define(['exports', 'pino', 'chalk', 'bullmq', 'zod', 'luxon', 'uuid', '@google-cloud/aiplatform', '@aws-sdk/client-s3', '@google-cloud/storage'], (function (exports, pino, chalk, bullmq, zod, luxon, uuid, aiplatform, clientS3, storage) { 'use strict';
